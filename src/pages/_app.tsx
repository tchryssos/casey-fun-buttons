...
const createGlobalStyles = (theme: Theme) => css`
  @import url('https://fonts.googleapis.com/css2?family=Fira+Sans:wght@600&family=Inconsolata:wght@300&&family=Manrope&family=Oleo+Script+Swash+Caps&family=Poppins&family=Rowdies:wght@300&display=swap');
  html {
    ${baseStyle};
  }
  body {
